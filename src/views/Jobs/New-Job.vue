          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <div class="row form-group mb-5">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input v-model="vacancy.company" type="text" id="company" class="form-control" placeholder="eg. Facebook, Inc.">
                </div>
              </div>
              ...
              <div class="row form-group mb-4">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <input v-model="vacancy.location" type="text" class="form-control" placeholder="Western City, UK">
                </div>
              </div>
